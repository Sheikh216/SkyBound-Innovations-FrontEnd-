		...
		<ul className="pt-2 pb-4 space-y-1 text-sm">
			<li className="dark:bg-gray-100 dark:text-gray-900">
				<a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
					...
					<Link to='/_/allusers'><span className='hover:text-blue-400'>ALL USERS</span></Link>
				</a>
			</li>
			<li>
				<a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
					...
					<Link to='/_/allAirlines' className='hover:text-blue-400'>ALL AIRLINES</Link>
				</a>
			</li>
			<li>
				<a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
					...
					<Link to='/_/allCoupons'>COUPONS</Link>
				</a>
			</li>
